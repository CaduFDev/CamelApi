...
namespace CamelDev.Comum.Repositorio.Entity
{
    public abstract class RepositorioCamelDev<TDominio, TChave> : IRepositorioCamelDev<TDominio, TChave> where TDominio : class
    {
        protected DbContext _context;
        public RepositorioCamelDev(DbContext context)
        {
            _context = context;
        }
